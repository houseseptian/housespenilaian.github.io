	...
	if ($kosong){
		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				...
				<a class="btn btn-outline-danger btn-sm" href="hpsmatkul.php?kode=<?php echo $row["idmatkul"]?>" id="linkHps" onclick="return confirm('Data ini akan dihapus secara permanen. Tindakan ini tidak dapat diurungkan')">Hapus</a>
				</td>
			</tr>
			<?php 
			$no++;
