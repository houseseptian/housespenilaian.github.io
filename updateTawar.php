...
<div class="utama">
	...
	<div class="text-center"><a href="prnmatkulPdf.php"><span class="fas fa-print">&nbsp;Cetak</span></a></div>
	...
	if ($kosong){
		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				...
				<td>
				<a class="btn btn-outline-primary btn-sm" href="editkultawar.php?idkultawar=<?php echo $row['idkultawar']?>">Edit</a>
				<a class="btn btn-outline-danger btn-sm" href="hpskultawar.php?idkultawar=<?php echo $row["idkultawar"]?>" id="linkHps" onclick="return confirm('Data ini akan dihapus secara permanen. Tindakan ini tidak dapat diurungkan')">Hapus</a>
				</td>
			</tr>
			<?php 
			$no++;
